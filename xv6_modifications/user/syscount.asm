...
int main(int argc, char *argv[]) {
  ...
  18:	8dc50513          	addi	a0,a0,-1828 # 8f0 <malloc+0x100>
  1c:	00000097          	auipc	ra,0x0
  20:	71c080e7          	jalr	1820(ra) # 738 <printf>
        exit(1);
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	382080e7          	jalr	898(ra) # 3a8 <exit>
  2e:	ec26                	sd	s1,24(sp)
  30:	e84a                	sd	s2,16(sp)
  32:	e44e                	sd	s3,8(sp)
  34:	84ae                	mv	s1,a1
  ...
  3c:	276080e7          	jalr	630(ra) # 2ae <atoi>
  40:	892a                	mv	s2,a0
    if (mask <= 0) {
  42:	02a05e63          	blez	a0,7e <main+0x7e>
  ...
  4a:	35a080e7          	jalr	858(ra) # 3a0 <fork>
  4e:	89aa                	mv	s3,a0
    if (pid < 0) {
  50:	04054463          	bltz	a0,98 <main+0x98>
        printf("Fork failed.\n");
        exit(1);
    } else if (pid == 0) {
  54:	ed39                	bnez	a0,b2 <main+0xb2>
        exec(argv[2], &argv[2]); // Run the command
  56:	01048593          	addi	a1,s1,16
  5a:	6888                	ld	a0,16(s1)
  5c:	00000097          	auipc	ra,0x0
  60:	384080e7          	jalr	900(ra) # 3e0 <exec>
        printf("exec failed\n");
  64:	00001517          	auipc	a0,0x1
  68:	8e450513          	addi	a0,a0,-1820 # 948 <malloc+0x158>
  6c:	00000097          	auipc	ra,0x0
  70:	6cc080e7          	jalr	1740(ra) # 738 <printf>
        exit(1);
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	332080e7          	jalr	818(ra) # 3a8 <exit>
        printf("Invalid mask value.\n");
  7e:	00001517          	auipc	a0,0x1
  82:	8a250513          	addi	a0,a0,-1886 # 920 <malloc+0x130>
  86:	00000097          	auipc	ra,0x0
  8a:	6b2080e7          	jalr	1714(ra) # 738 <printf>
        exit(1);
  8e:	4505                	li	a0,1
  90:	00000097          	auipc	ra,0x0
  94:	318080e7          	jalr	792(ra) # 3a8 <exit>
        printf("Fork failed.\n");
  98:	00001517          	auipc	a0,0x1
  9c:	8a050513          	addi	a0,a0,-1888 # 938 <malloc+0x148>
  a0:	00000097          	auipc	ra,0x0
  a4:	698080e7          	jalr	1688(ra) # 738 <printf>
        exit(1);
  a8:	4505                	li	a0,1
  aa:	00000097          	auipc	ra,0x0
  ae:	2fe080e7          	jalr	766(ra) # 3a8 <exit>
    } else {
        wait(NULL);
  b2:	4501                	li	a0,0
  b4:	00000097          	auipc	ra,0x0
  b8:	2fc080e7          	jalr	764(ra) # 3b0 <wait>
        int count = 0;
        count = getSysCount(mask); // Get the syscall count
  bc:	854a                	mv	a0,s2
  be:	00000097          	auipc	ra,0x0
  c2:	392080e7          	jalr	914(ra) # 450 <getSysCount>
  c6:	86aa                	mv	a3,a0
        int syscall_num = -1;
        for (int i = 0; i < 31; i++) {
            if (mask == (1 << i)) {  // Check which bit in the mask is set
  c8:	4785                	li	a5,1
  ca:	04f90863          	beq	s2,a5,11a <main+0x11a>
        for (int i = 0; i < 31; i++) {
  ce:	4781                	li	a5,0
  d0:	487d                	li	a6,31
            if (mask == (1 << i)) {  // Check which bit in the mask is set
  ...
  d8:	03078f63          	beq	a5,a6,116 <main+0x116>
            if (mask == (1 << i)) {  // Check which bit in the mask is set
  dc:	00f8973b          	sllw	a4,a7,a5
  e0:	ff271ae3          	bne	a4,s2,d4 <main+0xd4>
                syscall_num = i;
                break;
            }
        }
  ...
  e4:	2601                	sext.w	a2,a2
  e6:	4775                	li	a4,29
  e8:	02c76b63          	bltu	a4,a2,11e <main+0x11e>
  ec:	078e                	slli	a5,a5,0x3
  ee:	00001717          	auipc	a4,0x1
  f2:	30270713          	addi	a4,a4,770 # 13f0 <syscall_names>
 ...
 100:	85c50513          	addi	a0,a0,-1956 # 958 <malloc+0x168>
 ...
 112:	29a080e7          	jalr	666(ra) # 3a8 <exit>
        char *name = NULL;
 116:	4601                	li	a2,0
 118:	b7cd                	j	fa <main+0xfa>
 11a:	4601                	li	a2,0
 11c:	bff9                	j	fa <main+0xfa>
 11e:	4601                	li	a2,0
 120:	bfe9                	j	fa <main+0xfa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b4:	5e850513          	addi	a0,a0,1512 # a98 <digits>
 4b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ba:	48a70713          	addi	a4,a4,1162 # a40 <malloc+0x250>
 ...
 646:	456b8b93          	addi	s7,s7,1110 # a98 <digits>
 ...
 69c:	3a090913          	addi	s2,s2,928 # a38 <malloc+0x248>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77c:	d387b783          	ld	a5,-712(a5) # 14b0 <freep>
 ...
 7a4:	00e6ea63          	bltu	a3,a4,7b8 <free+0x4a>
{
 ...
 7e6:	ccf73723          	sd	a5,-818(a4) # 14b0 <freep>
}
 7ea:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 810:	ca453503          	ld	a0,-860(a0) # 14b0 <freep>
 ...
 840:	c7490913          	addi	s2,s2,-908 # 14b0 <freep>
  if(p == (char*)-1)
 844:	5afd                	li	s5,-1
 ...
 854:	c7078793          	addi	a5,a5,-912 # 14c0 <base>
 858:	00001717          	auipc	a4,0x1
 85c:	c4f73c23          	sd	a5,-936(a4) # 14b0 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8d2:	bea73123          	sd	a0,-1054(a4) # 14b0 <freep>
      return (void*)(p + 1);
