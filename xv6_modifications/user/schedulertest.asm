...
free(void *ap)
{
 ...
 728:	cbc7b783          	ld	a5,-836(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 7bc:	c2853503          	ld	a0,-984(a0) # 13e0 <freep>
 ...
 7ec:	bf890913          	addi	s2,s2,-1032 # 13e0 <freep>
  if(p == (char*)-1)
 7f0:	5afd                	li	s5,-1
 ...
 800:	bf478793          	addi	a5,a5,-1036 # 13f0 <base>
 ...
 87e:	b6a73323          	sd	a0,-1178(a4) # 13e0 <freep>
      return (void*)(p + 1);
